...
import com.myha.toeicwords.fragments.FragmentDefinition;
import com.myha.toeicwords.fragments.FragmentViDefinition;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c.moveToFirst()) {
            ...
            viDefinition=c.getString(c.getColumnIndex("vi_definition"));
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFrag(new FragmentViDefinition(), "Vi Definition");
